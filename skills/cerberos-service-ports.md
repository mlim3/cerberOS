...
| NATS client         | 4222           | 4222      | nats://localhost:4222                             |
...
| agents metrics      | 9090           | 9090      | http://localhost:9090/metrics (profile: agents)   |

## Internal DNS names (container-to-container)

| Hostname                  | Service           | Typical env var                                                  |
| ------------------------- | ----------------- | ---------------------------------------------------------------- |
| `nats`                    | NATS JetStream    | `NATS_URL=nats://nats:4222`                                      |
