...
func TestPreAuthorizeAndGetCredential(t *testing.T) {
	...
	token, err := b.PreAuthorize("agent-1", "task-1", "trace-1", []string{"db.password"})
	if err != nil {
...
func TestGetCredentialUnauthorizedKey(t *testing.T) {
	...
	b.PreAuthorize("agent-1", "task-1", "trace-1", []string{"db.password"}) //nolint:errcheck
...
func TestRevoke(t *testing.T) {
	...
	b.PreAuthorize("agent-1", "task-1", "trace-1", []string{"k"}) //nolint:errcheck
