...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/v1/agent/{taskId}/executions": {
            "get": {
        ...
        "/api/v1/chat/{conversationId}/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Hard cap on the number of recent turns to consider (default 40, max 500)",
                        "name": "max_turns",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Drop oldest turns until sum(tokenCount) <= budget. 0 disables trimming. Default 4000.",
                        "name": "token_budget",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.SessionHistoryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "api.SessionHistoryResponse": {
            ...
            "properties": {
                ...
                "turns": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.SessionHistoryTurn"
                    }
                }
            }
        },
        "api.SessionHistoryTurn": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
