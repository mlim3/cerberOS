...
Given that we are simplifying Vault's approach, we can consolidate the current 2 service structure into a single service.

You will be on the branch vault-core-v2, addressing issues #75 and #76 on github.

Commit at reasonable update points, use conventional commits, keep comments concise but helping teammates understand the changes.
